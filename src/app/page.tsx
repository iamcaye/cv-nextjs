          ...
          <CardComponent title="Work Experience" languages={['python', 'typescript', 'nodejs', "c-sharp-logo", "angularjs"]}>
            <div className="flex-col flex lg:flex-row items-center lg:items-top justify-between">
              <section className="ml-2">
                <p className="text-center lg:text-left text-balanced">Working as a <b>Software Developer</b> at <a className="text-red-600 text-bold" rel="noopener" target="_blank" href="https://grupotopdigital.es/">Grupo Topdigital</a>.</p>
